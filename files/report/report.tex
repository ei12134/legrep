...
\item $FilePath$ - caminho do ficheiro onde se pretende procurar o padrão
\item $T$ - cada linha de texto lida do ficheiro
\end{itemize}

\subsubsection*{Comandos opcionais de entrada}
\begin{itemize}

\item $-n$, uso do algoritmo $``naive'$ na pesquisa exacta
